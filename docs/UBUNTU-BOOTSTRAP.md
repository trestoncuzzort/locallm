# Ubuntu bootstrap — srlm-forge on cs-rahman-dell
...
`cs-rahman-dell` is shared with two PhD students (Ryan, Erfan). Written policy from
Dr. Rahman: **PhD experiments always take priority over undergraduate experiments.**
