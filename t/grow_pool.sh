...
echo "      --doc-batches --keep-every 50 --dropout 0.1 --split-seed 1337 --deterministic"
echo "  python3 t/pick_stopping_step.py --run t/out/locallm-r10 --split t/out/loop/split-v5.json \\"
echo "      --dev-ids t/r12-dev-ids.json --install      # the stopping step by dev tests, never by loss"
echo "  python3 t/loop_locallm.py generate --model t/out/locallm-r10 --tag locallm-r10 \\"
