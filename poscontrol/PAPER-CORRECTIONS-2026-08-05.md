...
**Date:** 2026-08-05
**Target of every citation:** `C:\Users\Kingo\Downloads\srlm-forge-arxiv-v3.md` (1,045 lines). Line
...
| tag | path |
|---|---|
| `ZCD` | `C:\Users\Kingo\source\srlm-forge\poscontrol\ZERO-COMPUTE-DIAGNOSTICS-2026-08-04.md` (§ ids and computation ids `S0`–`S10`, `F1`–`F11` are that file's) |
| `REP` | `C:\Users\Kingo\source\srlm-forge\poscontrol\REPLICATION-RESULT-2026-08-05.txt` |
| `RES` | `C:\Users\Kingo\source\srlm-forge\poscontrol\RESIDUALS-2026-08-04.md` (R-1 … R-6) |
| `RETRAIN` | `C:\Users\Kingo\source\srlm-forge\poscontrol\retrain.log` (27 lines) |
...
| `GIT` | branch `replication/2026-08-04` in `C:\Users\Kingo\source\srlm-forge`, commits `3ff32b24`, `fad2f184`, `91ce12c7`, `878eb6a1`; author's commit `eecdb2e` |
