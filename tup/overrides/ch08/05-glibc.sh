#!/bin/bash
# OVERRIDE ch08/05-glibc: run the critical test suite and JUDGE it, instead of
...
# tup takes (b).
#
# THE ALLOWLIST is quoted from chapter08/glibc.html (fetched 2026-08-31), not
# from memory: io/tst-lchmod (known to fail in the LFS chroot),
...
PAGE=""
for cand in /tup-build/book/ch08/05-glibc.sh /home/lfs/book/ch08/05-glibc.sh; do
